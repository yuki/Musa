...
class Musa {
    ...
    func updateRepeatButton(repeatButton: UIButton) {
        if Musa.player.repeatMode == MPMusicRepeatMode.none {
            ...
            repeatButton.setBackgroundImage(UIImage(named: "repeat")!, for: UIControl.State.normal)
            ...
            repeatButton.setBackgroundImage(UIImage(named: "repeat-one")!, for: UIControl.State.normal)
        } else {
            repeatButton.tintColor = UIColor.white
            repeatButton.backgroundColor = UIColor.MusaColor
            repeatButton.setBackgroundImage(UIImage(named: "repeat")!, for: UIControl.State.normal)
...
//    func returnColoredButton(name: String) -> Image? {
